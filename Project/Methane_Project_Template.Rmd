...
**what values should be in the table? total dataset or just specific to methane and our years? do all the things
...
From visualizing the total emission rates, dairy cattle and market swine showed the highest emission rates. We also decided to conduct a time series analysis to determine if there was a significant trend. The Mann-Kendall test confirmed that a significant trend was present for both animals (p-value < 0.05). 
...
#combine animal time series plots in grid
Cattle_Swine_plot <- plot_grid(Cattle_dairy_plot,Swine_market_plot)
print(Cattle_Swine_plot)
```
